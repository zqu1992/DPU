...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', type=str, default='reinit', help='The partial updating mode (just for the saved model name), allowed: reinit')
    ...
    parser.add_argument('--reinit_round', type=int, default=1, help='The number of rounds to re-initialize, i.e., reinitialize every reinit_round rounds')
    ...
    print('Re-initialization every ', args.reinit_round, ' rounds...')
    ...
    for r in range(num_rounds):
        ...
        # Compute the rewinding metric according to the combined contribution
        for p_dpu in DPU_layers:
